      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="mt-2 text-sm text-gray-400">
              Create AI-powered sound effects for your game development.
              Fast, easy, and fully customizable.
            </p>
          ...
          {/* Quick Links */}
          <div className="col-span-1 md:col-span-1">
            <h3 className="text-sm font-semibold text-gray-300 tracking-wider uppercase">Links</h3>
            <ul className="mt-4 space-y-4">
              ...
              <li>
                <Link href="/showcase" className="text-base text-gray-400 hover:text-gray-300">
                  Examples
                </Link>
              </li>
            </ul>
          ...
          <div className="col-span-1 md:col-span-1">
            ...
            <ul className="mt-4 space-y-4">
              ...
              <li>
                <Link href="/tutorials" className="text-base text-gray-400 hover:text-gray-300">
                  Tutorials
                </Link>
              </li>
            </ul>
        ...
        <div className="pt-8 mt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center">
          <p className="text-base text-gray-400">
            &copy; {currentYear} SoundFX. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
